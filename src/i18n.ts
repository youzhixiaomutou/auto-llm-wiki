...
export const ENGLISH_TRANSLATIONS = {
  ...
  "settings.gitAutoCommit.name": "Auto git commit after applying changes",
  "settings.gitAutoCommit.desc": "Commits wiki folder changes to git after each change plan is applied.",
